...
N_BK7_C = 1.51432  # Refractive index (BK7 at 656.3nm)
N_BK7_d = 1.51680  # Refractive index (BK7 at 587.6nm)
N_BK7_F = 1.52238  # Refractive index (BK7 at 486.1nm)
N_BK7_list = [N_BK7_C, N_BK7_d, N_BK7_F]
...
# https://www.thorlabs.co.jp/thorproduct.cfm?partnumber=LA1540-YAG
...
surface_2 = [[lens_pos+t_c1, 0., 0.]+lens_shift,
             [1., 0., 0.], 25.4/4, R_1]  # lens1->air

evaluation_plane = [[200.000, 0., 0.], [1., 0., 0.], 25.4/4, 0.]  # air->air
check_plane = [[lens_pos, 0., 0.], [1., 0., 0.], 25.4/4, 0.]  # air->air
