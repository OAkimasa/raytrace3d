...
VF.set_surface(surface_1,
               ...
               refractive_index_after=N_lens_1)  # surface_1を登録
...
VF.set_surface(surface_2,
               ...
               refractive_index_after=N_lens_2)  # surface_2を登録
VF.raytrace_sphere()  # 光線追跡
...
VF.set_surface(surface_3,
               ...
               refractive_index_after=N_air)  # surface_3を登録
VF.raytrace_sphere()  # 光線追跡
...
VF.set_surface(surface_4,
               refractive_index_before=N_air,
               refractive_index_after=N_lens_3)  # surface_4を登録
VF.raytrace_sphere()  # 光線追跡
...
VF.set_surface(surface_5,
               ...
               refractive_index_after=N_air)  # surface_5を登録
VF.raytrace_sphere()  # 光線追跡
...
VF.set_surface(surface_6,
               refractive_index_before=N_air,
               refractive_index_after=N_lens_4)  # surface_6を登録
VF.raytrace_sphere()  # 光線追跡
...
VF.set_surface(surface_7,
               ...
               refractive_index_after=N_lens_5)  # surface_7を登録
VF.raytrace_sphere()  # 光線追跡
...
VF.set_surface(surface_8,
               ...
               refractive_index_after=N_air)  # surface_8を登録
VF.raytrace_sphere()  # 光線追跡
...
ax_2.plot(VF.ray_end_pos[1], VF.ray_end_pos[2],
          optical_path_length - chief_ray_optical_path_list[8], "o")
