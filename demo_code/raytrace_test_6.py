...
print("VF_2 : ray_end_dir: ", VF_2.ray_end_dir)
print("VF_3 : ray_end_pos: ", VF_3.ray_end_pos)
print("VF_3 : ray_end_dir: ", VF_3.ray_end_dir)
ax.quiver(VF_1.ray_end_pos[0], VF_1.ray_end_pos[1], VF_1.ray_end_pos[2],
          5*VF_1._normalV_refract_or_reflect[0], 5 *
          VF_1._normalV_refract_or_reflect[1], 5 *
          VF_1._normalV_refract_or_reflect[2],
          color='red')
ax.quiver(VF_2.ray_end_pos[0], VF_2.ray_end_pos[1], VF_2.ray_end_pos[2],
          5*VF_2._normalV_refract_or_reflect[0], 5 *
          VF_2._normalV_refract_or_reflect[1], 5 *
          VF_2._normalV_refract_or_reflect[2],
          color='green')
ax.quiver(VF_3.ray_end_pos[0], VF_3.ray_end_pos[1], VF_3.ray_end_pos[2],
          5*VF_3._normalV_refract_or_reflect[0], 5 *
          VF_3._normalV_refract_or_reflect[1], 5 *
          VF_3._normalV_refract_or_reflect[2],
          color='blue')
